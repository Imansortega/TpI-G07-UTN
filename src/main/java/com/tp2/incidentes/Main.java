...
/*
 * //Alta clientes Cliente newClient = new Cliente("Lo de Pelos", 1187824334);
 * Cliente newClient1 = new Cliente("Almacen de Pepito", 1718147102);
 * 
 * // Instancio los servicios ClienteDbService miClienteDbServ = new
 * ClienteDbService(); ClienteMemService miClienteMemServ = new
 * ClienteMemService();
 * 
 ...
 * //miClienteDbServ.update(newClient); //miClienteDbServ.update(newClient1);
 * 
 * // Este lo pueden usar para actualizar la Razón Social
 * miClienteDbServ.actualizarRazonSocial(22,"Piripipi Guazú");
 * 
 * // Impresion contenido instancia Cliente en mem for (Cliente tempo :
 * miClienteMemServ.getAllClientes()) {
 * System.out.println("@ Main, Razón Social: " + tempo.getRazonSocial()); }
 * 
 * System.out.println("#######################################");
 * 
 * // Impresion contenido Db for (Cliente tempo : miClienteDbServ.findAll()) {
 * System.out.println("@ Main, Razón Social: " + tempo.getRazonSocial()); }
 */